    ...
    <div class="container p-0">
      <header>
        <div class="row mb-4 p-4 bg-primary d-flex flex-column justify-content-center align-item-center">
          ...
          <h4 class="text-white m-4 text-center">Créer un tableau associatif avec comme index le numéro des départements des Hauts de France et en valeur leur nom.</h4>
        </div>
      </header>
      <p class="text-center">
        <?php
